#include "HPE_node_embed.h"
#include<iostream>
#include<fstream>
#include<vector>

HPE_node_embed::HPE_node_embed() {}
HPE_node_embed::~HPE_node_embed() {}

void HPE_node_embed::SaveWeights(string model_name){
...
void HPE_node_embed::Init(int dim,string embed_path) {
...
void HPE_node_embed::Train(int sample_times, int walk_steps, int negative_samples, double reg, double alpha, int workers){
