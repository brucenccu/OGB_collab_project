#include "WARP_node_embed.h"
#include <omp.h>

WARP_node_embed::WARP_node_embed() {
...
void WARP_node_embed::LoadEdgeList(string filename, bool undirect) {
    pnet.LoadEdgeList(filename, undirect);
}

void WARP_node_embed::SaveWeights(string model_name){
...
void WARP_node_embed::Init(int dim,string embed_path) {
...
void WARP_node_embed::Train(int sample_times, int negative_samples, double alpha, double reg, int workers){
